...
public class Streets extends _DoPage {
	...
	public void doGET(_Session session, _WebFormData formData, String lang) {
		...
		if (user.hasRole("registrator")) {
			_Action newDocAction = new _Action(getLocalizedWord("new_street", lang),
					getLocalizedWord("add_new_street", lang), "new_street");
			newDocAction.setURL("Provider?id=street_form&key=");
