...
public class Positions extends _DoPage {
	...
	public void doGET(_Session session, _WebFormData formData, String lang) {
		...
		if (user.hasRole("registrator")) {
			_Action newDocAction = new _Action(getLocalizedWord("new_position", lang),
					getLocalizedWord("add_new_position", lang), "new_position");
			newDocAction.setURL("Provider?id=position_form&key=");
