...
public class Localities extends _DoPage {
	...
	public void doGET(_Session session, _WebFormData formData, String lang) {
		...
		if (user.hasRole("registrator")) {
			_Action newDocAction = new _Action(getLocalizedWord("new_locality", lang),
					getLocalizedWord("add_new_locality", lang), "new_locality");
			newDocAction.setURL("Provider?id=locality_form&key=");
