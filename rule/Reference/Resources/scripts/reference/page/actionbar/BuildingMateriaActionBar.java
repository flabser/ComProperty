...
public class BuildingMateriaActionBar extends _DoPage {
	...
	public void doGET(_Session session, _WebFormData formData, String lang) {
		...
		if (user.hasRole("registrator")) {
			_Action newDocAction = new _Action(getLocalizedWord("new_building_material", lang), getLocalizedWord("add_new_building_material", lang),
			        "new_building_material");
			newDocAction.setURL("Provider?id=building_material_form&key=");
