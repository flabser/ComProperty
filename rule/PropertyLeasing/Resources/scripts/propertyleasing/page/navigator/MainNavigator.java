...
public class MainNavigator extends _DoPage {
    ...
    public void doGET(_Session session, _WebFormData formData) {
        ...
        networkEntry.addEntry(new _OutlineEntry(getLocalizedWord("electric_networks", lang), "", "engineeringinfrastructure-view6031", eiUrl + "6031")); // ELECTRIC_NETWORKS(6031)
        networkEntry.addEntry(new _OutlineEntry(getLocalizedWord("thermal_networks", lang), "", "engineeringinfrastructure-view6032", eiUrl + "6032")); // THERMAL_NETWORKS(6032)
