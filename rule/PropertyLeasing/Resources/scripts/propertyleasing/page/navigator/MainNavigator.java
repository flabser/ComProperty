package propertyleasing.page.navigator;
...
public class MainNavigator extends _DoPage {
	...
	public void doGET(_Session session, _WebFormData formData) {
		...
		// BOMBPROOF(5021), FACTORY(5022), COMBINES(5023), AIRPORT(5024),
		// TRANSITIONS(5025)
		...
		specialConstructionEntry.addEntry(new _OutlineEntry(getLocalizedWord("airports", lang), "", "strategicobject-view5024", soUrl + "5024"));
		specialConstructionEntry.addEntry(new _OutlineEntry(getLocalizedWord("transitions", lang), "", "strategicobject-view5025", soUrl + "5025"));
		strategicObjectEntry.addEntry(specialConstructionEntry);

		// BILLBOARD(601), COLUMNS(602), ELECTRIC_NETWORKS(6031),
		// THERMAL_NETWORKS(6032), GAS(6033), WATER_SYSTEM(6034), DRAIN(6035),
		// ROAD(604), PARKING(605)
		...
		engStructureEntry.addEntry(new _OutlineEntry(getLocalizedWord("billboards", lang), "", "engineeringinfrastructure-view601", eiUrl + "601"));
		engStructureEntry.addEntry(new _OutlineEntry(getLocalizedWord("columns", lang), "", "engineeringinfrastructure-view602", eiUrl + "602"));

		_OutlineEntry networkEntry = new _OutlineEntry(getLocalizedWord("networks", lang), "", "engineeringinfrastructure-view603", eiUrl + "603");
		networkEntry
		        .addEntry(new _OutlineEntry(getLocalizedWord("electric_networks", lang), "", "engineeringinfrastructure-view6031", eiUrl + "6031"));
		networkEntry
		        .addEntry(new _OutlineEntry(getLocalizedWord("thermal_networks", lang), "", "engineeringinfrastructure-view6032", eiUrl + "6032"));
		networkEntry.addEntry(new _OutlineEntry(getLocalizedWord("gas", lang), "", "engineeringinfrastructure-view6033", eiUrl + "6033"));
		networkEntry.addEntry(new _OutlineEntry(getLocalizedWord("water_systems", lang), "", "engineeringinfrastructure-view6034", eiUrl + "6034"));
		networkEntry.addEntry(new _OutlineEntry(getLocalizedWord("drain", lang), "", "engineeringinfrastructure-view6035", eiUrl + "6035"));
		engStructureEntry.addEntry(networkEntry);
		engStructureEntry.addEntry(new _OutlineEntry(getLocalizedWord("roads", lang), "", "engineeringinfrastructure-view604", eiUrl + "604"));
		engStructureEntry.addEntry(new _OutlineEntry(getLocalizedWord("parkings", lang), "", "engineeringinfrastructure-view605", eiUrl + "605"));
