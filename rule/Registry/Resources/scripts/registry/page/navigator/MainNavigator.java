...
public class MainNavigator extends _DoPage {
	...
	public void doGET(_Session session, WebFormData formData) {
		...
		try {
			for (OrgCategory cat : new OrgCategoryDAO(session).findAll().getResult()) {
				orgEntry.addEntry(new _OutlineEntry(cat.getLocName(lang),
						getLocalizedWord("labeled", lang) + " : " + cat.getLocName(lang),
