...
public enum KufType {
	UNKNOWN(0), FURNITURE(101), ANIMALS(102), SHARE_BLOCK(104), EQUITY(105), OTHERS(106), SCHOOL_EQUIPMENT(201), OFFICE_EQUIPMENT(202), COMPUTER_EQUIPMENT(
	        203), MEDICAL_EQUIPMENT(204), COOK_EQUIPMENT(205), EQUIPMENT_OF_CIVIL_DEFENSE(206), OTHERS_EQUIPMENT(207), BUILDINGS(301), ROOMS(302), STRUCTURES(
	        303), RESIDENTIAL_OBJECTS(304), LAND(305), MONUMENT(306), /*
																	 * AUTOMOBILE
																	 * ( 401 ) ,
																	 */
	AUTOMOBILE(4011), CARGO(4012), DEJ_TRANSPORT(4013), OFFICIAL_TRANSPORT(4014), HOSPITAL_TRANSPORT(4015), BUS(40161), TROLLEYBUS(40162), TRAM(40163), TAXI(
	        40164), WATER_TRANSPORT(40165), SPECIAL_EQUIPMENT(402), MOTORCYCLE(403), OBJECT_RESERVED_FUND(501), BOMBPROOF(5021), FACTORY(5022), COMBINES(
	        5023), AIRPORT(5024), TRANSITIONS(5025), BILLBOARD(601), COLUMNS(602), ELECTRIC_NETWORKS(6031), THERMAL_NETWORKS(6032), GAS(6033), WATER_SYSTEM(
	        6034), DRAIN(6035), ROAD(604), PARKING(605), SPORT_EQUIPMENT(103);
