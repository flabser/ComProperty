...
public enum KufType {
	UNKNOWN(0), FURNITURE(101), ANIMALS(102), OTHERS(106), SCHOOL_EQUIPMENT(201), COMPUTER_EQUIPMENT(203), COOK_EQUIPMENT(205), EQUIPMENT_OF_CIVIL_DEFENSE(
	        206), OTHERS_EQUIPMENTS(207), BUILDINGS(301), ROOMS(302), STRUCTURES(303), RESIDENTIAL_OBJECTS(304), LAND(305), MONUMENT(306), /*
																																			 * AUTOMOBILE
																																			 * (
																																			 * 401
																																			 * )
