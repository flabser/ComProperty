...
public abstract class StrategicObjectForm extends MunicipalPropertyForm {
	...
	protected StrategicObject getDefaultEntity(User user, KufType type, _Session session) {
