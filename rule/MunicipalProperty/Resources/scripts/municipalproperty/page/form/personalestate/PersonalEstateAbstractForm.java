...
public abstract class PersonalEstateAbstractForm extends MunicipalPropertyForm {
    ...
    protected PersonalEstate getDefaultEntity(IUser user, KufType type, _Session session) {
