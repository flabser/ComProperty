...
public class MainNavigator extends _DoPage {
    ...
    public void doGET(_Session session, _WebFormData formData) {
        ...
        personalEstateEntry.addEntry(new _OutlineEntry(getLocalizedWord("inventory", lang), "", "personalestate-view103", peUrl + "103")); // SPORT_EQUIPMENT(103)
        ...
        equipmentEntry.addEntry(new _OutlineEntry(getLocalizedWord("computer_equipment", lang), "", "equipment-view203", eqUrl + "203")); // COMPUTER_EQUIPMENT(203)
        equipmentEntry.addEntry(new _OutlineEntry(getLocalizedWord("medical_equipment", lang), "", "equipment-view204", eqUrl + "204")); // MEDICAL_EQUIPMENT(204)
        equipmentEntry.addEntry(new _OutlineEntry(getLocalizedWord("cook_equipment", lang), "", "equipment-view205", eqUrl + "205")); // COOK_EQUIPMENT(205)
        equipmentEntry.addEntry(new _OutlineEntry(getLocalizedWord("equipment_of_civil_defence", lang), "", "equipment-view206", eqUrl + "206")); // EQUIPMENT_OF_CIVIL_DEFENCE(206)
        equipmentEntry.addEntry(new _OutlineEntry(getLocalizedWord("others_equipment", lang), "", "equipment-view207", eqUrl + "207")); // OTHERS_EQUIPMENT(207)
        ...
        // TODO ROOMS(302) ?
        realEstateEntry.addEntry(new _OutlineEntry(getLocalizedWord("structures", lang), "", "realestate-view303", reUrl + "303")); // STRUCTURES(303)
        realEstateEntry.addEntry(new _OutlineEntry(getLocalizedWord("residential_objects", lang), "", "realestate-view304", reUrl + "304")); // RESIDENTIAL_OBJECTS(304)
        realEstateEntry.addEntry(new _OutlineEntry(getLocalizedWord("land", lang), "", "realestate-view305", reUrl + "305")); // LAND(305)
        ...
        autoEntry.addEntry(new _OutlineEntry(getLocalizedWord("dej_transport", lang), "", "vehicle-view4013", trUrl + "4013")); // DEJ_TRANSPORT(4013)
        autoEntry.addEntry(new _OutlineEntry(getLocalizedWord("official_transport", lang), "", "vehicle-view4014", trUrl + "4014")); // OFFICIAL_TRANSPORT(4014)
        ...
        passengerTransportEntry.addEntry(new _OutlineEntry(getLocalizedWord("taxi", lang), "", "vehicle-view40164", trUrl + "40164")); // TAXI(40164)
        passengerTransportEntry.addEntry(new _OutlineEntry(getLocalizedWord("water_transports", lang), "", "vehicle-view40165", trUrl + "40165")); // WATER_TRANSPORT(40165)
        autoEntry.addEntry(passengerTransportEntry);

        transportEntry.addEntry(new _OutlineEntry(getLocalizedWord("special_equipment", lang), "", "vehicle-view402", trUrl + "402")); // SPECIAL_EQUIPMENT(402)
        ...
        strategicObjectEntry
                .addEntry(new _OutlineEntry(getLocalizedWord("object_reserved_fund", lang), "", "strategicobject-view501", soUrl + "501"));

        _OutlineEntry specialConstructionEntry = new _OutlineEntry(getLocalizedWord("special_constructions", lang), "", "strategicobject-view502",
                soUrl + "502");
        specialConstructionEntry.addEntry(new _OutlineEntry(getLocalizedWord("bomb_proofs", lang), "", "strategicobject-view5021", soUrl + "5021")); // BOMBPROOF(5021)
        specialConstructionEntry.addEntry(new _OutlineEntry(getLocalizedWord("factory", lang), "", "strategicobject-view5022", soUrl + "5022")); // FACTORY(5022)
        specialConstructionEntry.addEntry(new _OutlineEntry(getLocalizedWord("combines", lang), "", "strategicobject-view5023", soUrl + "5023")); // COMBINES(5023)
        specialConstructionEntry.addEntry(new _OutlineEntry(getLocalizedWord("airports", lang), "", "strategicobject-view5024", soUrl + "5024")); // AIRPORT(5024)
        specialConstructionEntry.addEntry(new _OutlineEntry(getLocalizedWord("transitions", lang), "", "strategicobject-view5025", soUrl + "5025")); // TRANSITIONS(5025)
        ...
        _OutlineEntry networkEntry = new _OutlineEntry(getLocalizedWord("networks", lang), "", "engineeringinfrastructure-view603", eiUrl + "603");
        networkEntry
                .addEntry(new _OutlineEntry(getLocalizedWord("electric_networks", lang), "", "engineeringinfrastructure-view6031", eiUrl + "6031")); // ELECTRIC_NETWORKS(6031)
        networkEntry
                .addEntry(new _OutlineEntry(getLocalizedWord("thermal_networks", lang), "", "engineeringinfrastructure-view6032", eiUrl + "6032")); // THERMAL_NETWORKS(6032)
        networkEntry.addEntry(new _OutlineEntry(getLocalizedWord("gas", lang), "", "engineeringinfrastructure-view6033", eiUrl + "6033")); // GAS(6033)
        networkEntry.addEntry(new _OutlineEntry(getLocalizedWord("water_systems", lang), "", "engineeringinfrastructure-view6034", eiUrl + "6034")); // WATER_SYSTEM(6034)
        networkEntry.addEntry(new _OutlineEntry(getLocalizedWord("drain", lang), "", "engineeringinfrastructure-view6035", eiUrl + "6035")); // DRAIN(6035)
        ...
        for (PropertyCode propCode : new PropertyCodeDAO(session).findAll()) {
            mpByPropertyCodeOutline.addEntry(new _OutlineEntry(propCode.getLocalizedName(lang), "",
