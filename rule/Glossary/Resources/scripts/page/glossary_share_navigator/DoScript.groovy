package page.glossary_share_navigator
...
class DoScript extends _DoScript {
	...
	public void doProcess(_Session session, _WebFormData formData, String lang) {
		...
		if (user.hasRole("registrator")){
            ...
            glossary_outline.addEntry(new _OutlineEntry(getLocalizedWord("Учреждения",lang), getLocalizedWord("Учреждения",lang), "institution", "Provider?type=page&id=institution"))
