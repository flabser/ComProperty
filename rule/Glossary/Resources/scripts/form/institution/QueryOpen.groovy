...
class QueryOpen extends _FormQueryOpen{
	...
	public void doQueryOpen(_Session session, _WebFormData webFormData, String lang) {
		publishValue("title",getLocalizedWord("Учреждение", lang))
	...
	public void doQueryOpen(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		...
		publishValue("title",getLocalizedWord("Учреждение", lang) + ":" + glos.getViewText())
		publishEmployer("author",glos.getAuthorID())
		publishValue("name",glos.getName())
		publishValue("kazname",glos.getValueString("kazname"))
        publishValue("contacts",glos.getValueString("contacts"))
