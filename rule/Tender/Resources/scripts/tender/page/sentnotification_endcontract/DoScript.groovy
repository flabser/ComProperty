package tender.page.sentnotification_endcontract
...
class DoScript extends _DoScript {
	...
	public void doProcess(_Session ses, _WebFormData formData, String lang) {
		...
		_doc.addStringField("reason", formData.getEncodedValueSilently("reason"));
		...
		_doc.addStringField("notificationtype", "notif_endcontract")
		...
		_doc.setViewText("Уведомление о расторжении договора: договор №"+ doc.getValueString("regnumber") + " от " + doc.getValueString("regdate"))
		_doc.addViewText("notif_endcontract")
