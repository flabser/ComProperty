package handler.residential_buildings
...
class Trigger extends _DoScheduledHandler {
    ...
    public int doHandler(_Session session) {
        ...
        File xlsFile = new File("Жилые_здания.xls");
        ...
        for (int i = 1; i < sheet.getRows(); i++) {
            ...
            doc.setForm("residentialobjects");
                 ...
                 if (cell.type != CellType.EMPTY && cell.cellFormat != null) {
                     switch (j) {
                         ...
                         case 11:
                             ...
                             break;
                         case 16:
                             String originalcost = ((NumberCell) cell).getValue().intValue().toString()
                             doc.setValueString("originalcost", originalcost)
                             break
                         case 17:
                             String cumulativedepreciation = ((NumberCell) cell).getValue().intValue().toString()
                             doc.setValueString("cumulativedepreciation", cumulativedepreciation)
                             break
                         case 18:
                             String depreciating = ((NumberCell) cell).getValue().intValue().toString()
                         ...
                         case 25:
                             ...
                             break
                         case 29:
                             String countfloors = ((NumberCell) cell).getValue().intValue().toString()
                             doc.setValueString("countfloors", countfloors)
                             break
                         case 31:
                             String totalarea = ((NumberCell) cell).getValue().intValue().toString()
                             doc.setValueString("totalarea", totalarea)
                             break
                         case 33:
                             String usefularea = ((NumberCell) cell).getValue().intValue().toString()
                         ...
                         case 40:
                             ...
                             break;
                         case 41:
                             String yearconstruction = ((NumberCell) cell).getValue().intValue().toString()
                             doc.setValueString("yearconstruction", yearconstruction)
                             break
                         case 42:
                             String deterioration = ((NumberCell) cell).getValue().intValue().toString()
