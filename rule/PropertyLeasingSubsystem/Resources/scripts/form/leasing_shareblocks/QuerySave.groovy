package form.leasing_shareblocks
...
class QuerySave extends _FormQuerySave {
	...
	public void doQuerySave(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		...
		doc.setForm("shareblocks");
		doc.addStringField("note",webFormData.getValueSilently("note"))
		doc.addStringField("address", webFormData.getValueSilently("address"))
		doc.addNumberField("registryholder", webFormData.getNumberValueSilently("registryholder", 0))
		doc.addGlossaryField("typeofactions", webFormData.getValueSilently("typeofactions").toInteger())
		doc.addGlossaryField("formofactions", webFormData.getValueSilently("formofactions").toInteger())
		doc.addStringField("parvalue",webFormData.getValueSilently("parvalue"))
		...
		doc.addStringField("amount",webFormData.getValueSilently("amount"))
		Date cDate = null
