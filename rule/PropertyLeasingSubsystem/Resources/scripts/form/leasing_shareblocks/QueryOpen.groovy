...
class QueryOpen extends _FormQueryOpen {
	...
	public void doQueryOpen(_Session ses, _Document doc, _WebFormData webFormData, String lang) {
		...
		publishGlossaryValue("typeofactions",doc.getValueString("typeofactions").toInteger())
		publishGlossaryValue("formofactions",doc.getValueString("formofactions").toInteger())
