...
class QuerySave extends _FormQuerySave {
	...
	public void doQuerySave(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		...
		doc.addGlossaryField("street", webFormData.getNumberValueSilently("street", 0))
		doc.addGlossaryField("kt", webFormData.getValue("kt").toInteger())
		doc.addStringField("home", webFormData.getValueSilently("home"))
		doc.addGlossaryField("limitdepreciation", webFormData.getNumberValueSilently("limitdepreciation", 0))
		...
		doc.addStringField("assignment",webFormData.getValueSilently("assignment"))
