package form.leasing_furniture
...
class QuerySave extends _FormQuerySave {
	...
	public void doQuerySave(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		...
		doc.addStringField("width", webFormData.getValueSilently("width"))
		doc.addStringField("height", webFormData.getValueSilently("height"))
		doc.addStringField("depth", webFormData.getValueSilently("depth"))
