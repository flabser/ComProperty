package form.leasing_sportsequipment
...
class QuerySave extends _FormQuerySave {
	...
	public void doQuerySave(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		...
		doc.addStringField("totalcost",webFormData.getValueSilently("totalcost"))
		doc.addEditor(webFormData.getValue("author"))
		doc.addEditor("[operator]")
		doc.addGlossaryField("typesportsequipment", webFormData.getValueSilently("typesportsequipment").toInteger())
