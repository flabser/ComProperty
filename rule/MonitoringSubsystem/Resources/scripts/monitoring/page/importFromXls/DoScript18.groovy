 ...
 */
class DoScript18 extends _DoScript {
	...
	public void doProcess(_Session session, _WebFormData webFormData, String lang) {
		...
		// Листы
		Sheet sheet1 = excelFile.getSheet(18);
		...
		//for(int i=13; i<=21; i++){
			...
			doc.addStringField("namerus", "Государственное коммунальное казенное производственно-эксплуатационое предприятие аппарата акима г.Алматы" )
