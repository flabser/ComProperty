 ...
 * 24ый лист
 */
class DoScript24 extends _DoScript {
	...
	public void doProcess(_Session session, _WebFormData webFormData, String lang) {
		...
		// Листы
		Sheet sheet1 = excelFile.getSheet(24);
		// sheet 24 - for(int i=9; i<=10; i++){
		// sheet 25 for(int i=9; i<=9; i++){
		for(int i=9; i<=10; i++){
			// col - column
			...
			doc.addStringField("namerus", "Государственный фонд развития молодежной политики");
