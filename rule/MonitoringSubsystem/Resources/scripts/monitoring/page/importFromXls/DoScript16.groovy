 ...
 */
class DoScript16 extends _DoScript {
	...
	public void doProcess(_Session session, _WebFormData webFormData, String lang) {
		...
		// Листы
		Sheet sheet1 = excelFile.getSheet(16);
		...
		//for(int i=13; i<=21; i++){
			...
			doc.addStringField("namerus", "ГКП ПХВ 'Алматы қала құрылысы кадастры' Акимата города Алматы" )
