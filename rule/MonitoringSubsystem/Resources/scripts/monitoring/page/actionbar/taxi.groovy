...
class taxi extends _DoScript { 
	...
	public void doProcess(_Session session, _WebFormData formData, String lang) {
		...
		if (user.hasRole(["registrator"])){
			def newDocAction = new _Action(getLocalizedWord("Добавить", lang),getLocalizedWord("Добавить такси",lang), "new_document")
			newDocAction.setURL("Provider?type=edit&element=document&id=taxi&key=")
