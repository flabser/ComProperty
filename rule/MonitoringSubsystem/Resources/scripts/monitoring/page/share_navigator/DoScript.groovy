package monitoring.page.share_navigator
...
class DoScript extends _DoScript {
	...
	public void doProcess(_Session session, _WebFormData formData, String lang) {
		...
		//personalestate_outline.addEntry(new _OutlineEntry(getLocalizedWord("Мебель",lang), getLocalizedWord("Мебель",lang), "furniture_", "Provider?type=page&id=furniture_&page=0"))
		...
		equipment_outline.addEntry(new _OutlineEntry(getLocalizedWord("Прочее оборудование",lang), getLocalizedWord("Прочее оборудование",lang), "others_equipment", "Provider?type=page&id=others_equipment&page=0"))
		...
		def objpropertytype = new _Outline(getLocalizedWord("Объекты по типу права на имущество",lang), getLocalizedWord("Объекты по типу права на имущество",lang), "objpropertytype")
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Доверительное управление",lang), getLocalizedWord("Доверительное управление",lang), "trustmanagements", "Provider?type=page&id=trustmanagements&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Безвозмездное пользование",lang), getLocalizedWord("Безвозмездное пользование",lang), "freeuses", "Provider?type=page&id=freeuses&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Концессия",lang), getLocalizedWord("Концессия",lang), "concessions", "Provider?type=page&id=concessions&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Собственность",lang), getLocalizedWord("Собственность",lang), "ownerships", "Provider?type=page&id=ownerships&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Хозяйственное ведение",lang), getLocalizedWord("Хозяйственное ведение",lang), "economicguiding", "Provider?type=page&id=economicguiding&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Оперативное управление",lang), getLocalizedWord("Оперативное управление",lang), "operationalmanagement", "Provider?type=page&id=operationalmanagement&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Вклад в уставной капитал",lang), getLocalizedWord("Вклад в уставной капитал",lang), "contributioncapital", "Provider?type=page&id=contributioncapital&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Распоряжение",lang), getLocalizedWord("Распоряжение",lang), "disposal", "Provider?type=page&id=disposal&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Ответственное хранение",lang), getLocalizedWord("Ответственное хранение",lang), "safecustody", "Provider?type=page&id=safecustody&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Объекты, закрепленные за управлением",lang), getLocalizedWord("Объекты, закрепленные за управлением",lang), "fixedbehindcontrol", "Provider?type=page&id=fixedbehindcontrol&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Оперативное пользование",lang), getLocalizedWord("Оперативное пользование",lang), "operationaluse", "Provider?type=page&id=operationaluse&page=0"))
		objpropertytype.addEntry(new _OutlineEntry(getLocalizedWord("Временное безвозмездное пользование",lang), getLocalizedWord("Временное безвозмездное пользование",lang), "temporaryfreeuse", "Provider?type=page&id=temporaryfreeuse&page=0"))
		outline.addOutline(objpropertytype)
		list.add(objpropertytype)
		...
		def order = new _Outline(getLocalizedWord("Постановления",lang), getLocalizedWord("Постановления",lang), "orders")
		order.addEntry(new _OutlineEntry(getLocalizedWord("Постановления",lang), getLocalizedWord("Постановления",lang), "order", "Provider?type=page&id=order&page=0"))
		outline.addOutline(order)
		list.add(order)

		def contracts = new _Outline(getLocalizedWord("Договора и доп.соглашения",lang), getLocalizedWord("Договора и доп.соглашения",lang), "contracts")
		contracts.addEntry(new _OutlineEntry(getLocalizedWord("Договора и доп.соглашения",lang), getLocalizedWord("Договора и доп.соглашения",lang), "contract", "Provider?type=page&id=contract&page=0"))
		outline.addOutline(contracts)
		list.add(contracts)
		...
		notifications_outline.addEntry(new _OutlineEntry(getLocalizedWord("Регистрация объектов",lang), getLocalizedWord("Уведомления об регистрации объектов",lang), "reg_notification", "Provider?type=page&id=reg_notification&page=0"))
