package monitoring.form.animals
...
class QuerySave extends _FormQuerySave {
	...
	public void doQuerySave(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		...
		doc.addNumberField("animalstype", webFormData.getNumberValueSilently("animalstype", 0))
		...
		doc.addStringField("breed", webFormData.getValueSilently("breed"))
		doc.addStringField("age", webFormData.getValueSilently("age"))
		doc.addStringField("weight", webFormData.getValueSilently("weight"))
