...
class QueryOpen extends _FormQueryOpen {
	...
	public void doQueryOpen(_Session ses, _WebFormData webFormData, String lang) {
		...
		publishValue("title",getLocalizedWord("Движимое имущество - Животные", lang))
	...
	public void doQueryOpen(_Session ses, _Document doc, _WebFormData webFormData, String lang) {
		...
		if(doc.getField('animalstype')){
			publishGlossaryValue("animalstype",doc.getValueGlossary("animalstype"))
		}
		publishValue("breed",doc.getValueString("breed"))
		publishValue("age",doc.getValueString("age"))
		publishValue("weight",doc.getValueString("weight"))
