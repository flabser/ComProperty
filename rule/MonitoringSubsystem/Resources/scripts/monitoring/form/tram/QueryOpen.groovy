...
class QueryOpen extends _FormQueryOpen {
	...
	public void doQueryOpen(_Session ses, _WebFormData webFormData, String lang) {
		...
		publishValue("title",getLocalizedWord("Транспорт - Трамвай", lang))
	...
	public void doQueryOpen(_Session ses, _Document doc, _WebFormData webFormData, String lang) {
		...
		if(doc.getField('limitdepreciation')){
		...
		publishValue("quantitypassengerseats",doc.getValueString("quantitypassengerseats"))
		publishValue("quantitypassengerseats_rh",doc.getValueString("quantitypassengerseats_rh"))
