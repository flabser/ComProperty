...
class QueryOpen extends _FormQueryOpen {
	...
	public void doQueryOpen(_Session ses, _WebFormData webFormData, String lang) {
		...
		publishValue("title",getLocalizedWord("Движимое имущество - инвентарь", lang))
	...
	public void doQueryOpen(_Session ses, _Document doc, _WebFormData webFormData, String lang) {
		...
		publishValue("totalcost",doc.getValueString("totalcost"))
		if(doc.getField('typesportsequipment')){
			publishGlossaryValue("typesportsequipment",doc.getValueString("typesportsequipment").toInteger())
		}
