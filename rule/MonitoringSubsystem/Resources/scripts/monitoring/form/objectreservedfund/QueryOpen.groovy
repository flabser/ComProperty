package monitoring.form.objectreservedfund
...
class QueryOpen extends _FormQueryOpen {
	...
	public void doQueryOpen(_Session ses, _WebFormData webFormData, String lang) {
		...
		publishValue("title",getLocalizedWord("Стратегические объекты - Объекты государственного природно-заповедного фонда", lang))
