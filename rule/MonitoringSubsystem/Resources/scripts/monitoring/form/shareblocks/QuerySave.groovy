...
class QuerySave extends _FormQuerySave {
	...
	public void doQuerySave(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		...
		doc.addNumberField("typeofactions", webFormData.getNumberValueSilently("typeofactions", 0))
		doc.addNumberField("formofactions", webFormData.getNumberValueSilently("formofactions", 0))
