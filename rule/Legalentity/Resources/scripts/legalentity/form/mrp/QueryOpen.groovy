...
class QueryOpen extends _FormQueryOpen{
	...
	public void doQueryOpen(_Session session, _WebFormData webFormData, String lang) {
		publishValue("title",getLocalizedWord("МРП", lang))
	...
	public void doQueryOpen(_Session session, _Document doc, _WebFormData webFormData, String lang) {
		...
		publishValue("title",getLocalizedWord("МРП", lang) + ":" + glos.getViewText())
		publishEmployer("author",glos.getAuthorID())
		publishValue("year",glos.getValueString("year"))
		publishValue("value", glos.getValueString("value"))
