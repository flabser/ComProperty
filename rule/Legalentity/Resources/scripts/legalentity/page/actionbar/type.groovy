...
class type extends _DoScript { 
	...
	public void doProcess(_Session session, _WebFormData formData, String lang) {
		...
		if (user.hasRole(["registrator"])){
			def newDocAction = new _Action(getLocalizedWord("Добавить", lang),getLocalizedWord("Добавить тип",lang), "new_glossary")
			newDocAction.setURL("Provider?type=edit&id=type&key=")
