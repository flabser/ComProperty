...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//query/entry">
		...
		<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}">
			...
			<td style="border:1px solid #ccc; width:30px; padding:3px">
						...
						<div id="viewcontent">
							<div id="viewcontent-header" style="height:130px;">
								...
								<div class="button_panel" style="margin-top:1px">
                                    <div style="float:left; margin-left:3px; margin-top:2px; margin-bottom:3px; height:31px">
                                        <button id ="backtodocuments">
                                            <xsl:attribute name="onclick">javascript:<xsl:value-of select="//actionbar/action[@id='close']/js"/>;</xsl:attribute>
                                            <img src="/SharedResources/img/classic/icons/arrow_left.png" class="button_img"/>
                                            <font style="font-size:12px; vertical-align:top">
                                                <xsl:value-of select="//actionbar/action[@id='close']/@caption"/>
                                            </font>
                                        </button>
                                    </div>
