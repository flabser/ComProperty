						...
						<div class="button_panel">
							<span style="float:left">
								...
								<button title ="{document/captions/saveclose/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnsavedoc">
									<xsl:attribute name="onclick">javascript:SaveFormJquery(&quot;<xsl:value-of select="history/entry[@type eq 'page'][last()]"/>&quot;)</xsl:attribute>
									<span>
										...
										<table width="100%" border="0">
											...
											<tr>
												...
												<td style="padding-top:5px">
													...
													<select size="1" name="city" style="width:310px;" class="select_editable">
														<xsl:if test="$editmode != 'edit'">
