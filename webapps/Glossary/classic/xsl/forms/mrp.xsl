									...
									<div display="block" id="property">
										...
										<tr>
											...
											<td>
												...
												<input type="text" value="{document/fields/year}" style="width:40px;" class="td_editable" name="year" autocomplete="off" pattern="^18\d\d$|^19\d\d$|^20[{substring($year,3,1)}][0-{substring($year,4,1)}]$|^200[0-9]$" onkeyup="javascript:validationyearfield(this)">
									       ...
									       <tr>
									       		<td class="fc"><xsl:value-of select="document/captions/value/@caption"/> :</td>
												<td>
													<input type="text" name="value" id="value" value="{document/fields/value}" size="10" class="td_editable" style="width:120px">
														<xsl:if test="$editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="class">td_noteditable</xsl:attribute>
														</xsl:if>
