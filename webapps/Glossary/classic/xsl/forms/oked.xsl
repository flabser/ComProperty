								...
								<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
									<div display="block" id="property">
										...
										<table width="100%" border="0">
											<tr>
												<td width="30%" class="fc"><xsl:value-of select="document/captions/namerus/@caption"/> :</td>
										        <td>
								                	<input type="text" name="namerus" value="{document/fields/namerus}" size="30" class="td_editable" style="width:300px">
											...
											<tr>
												<td width="30%" class="fc"><xsl:value-of select="document/captions/namekaz/@caption"/> :</td>
										        <td>
								                	<input type="text" name="namekaz" value="{document/fields/namekaz}" size="30" class="td_editable" style="width:300px">
								                      	<xsl:if test="$editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="class">td_noteditable</xsl:attribute>
														</xsl:if>
									...
									<input type="hidden" name="direction" value="направление"/> 
					   			</form>
					    	</div>
					    </div>
