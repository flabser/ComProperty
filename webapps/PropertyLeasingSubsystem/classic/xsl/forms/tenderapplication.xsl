				...
				<div class="formwrapper">
					...
					<div class="button_panel">
						<span style="width:80%; vertical-align:12px; float:left">
                            ...
                            <xsl:if test="document/actionbar/action[@id='approve']/@mode = 'ON'">
                                <button title="{document/actionbar/action [@id='approve']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnapprovedoc">
                                    <xsl:attribute name="onclick">javascript:reviewRentApplication('<xsl:value-of select="document/@id" />', "approved", 'tender')</xsl:attribute>
                                    <span>
                                        <img src="/SharedResources/img/classic/icons/tick.png" class="button_img"/>
                                        <font style="font-size:12px; vertical-align:top"><xsl:value-of select="document/actionbar/action [@id='approve']/@caption"/></font>
                                    </span>
                                </button>
                            </xsl:if>
                            &#xA0;
                            <xsl:if test="document/actionbar/action[@id='reject']/@mode = 'ON'">
                                <button title="{document/actionbar/action [@id='reject']/@hint}" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" id="btnrejectdoc">
                                    <xsl:attribute name="onclick">javascript:reviewRentApplication('<xsl:value-of select="document/@id" />', "rejected", 'tender')</xsl:attribute>
                                    <span>
                                        <img src="/SharedResources/img/classic/icons/cross.png" class="button_img"/>
                                        <font style="font-size:12px; vertical-align:top"><xsl:value-of select="document/actionbar/action [@id='reject']/@caption"/></font>
                                    </span>
                                </button>
                            </xsl:if>
						</span>
								...
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
										...
										<tr>
											...
											<td>
												<a class="doclink" href="{document/fields/tenderurl}">
													<xsl:value-of select="document/fields/tendername"/>
												</a>
											</td>
										</tr>
										<!-- Адрес -->
                                        ...
                                        <tr>
                                            <td class="fc">
                                                <xsl:value-of select="document/captions/cost/@caption"/>&#xA0;:
                                            </td>
                                            <td>
                                                <input type="text" value="***" name="cost" style="width:200px;" onkeydown="javascript:numericfield(this)" class="td_editable"  autocomplete="off">
                                                    <xsl:if test="document/status != 'new'">
                                                        <xsl:attribute name="readonly">readonly</xsl:attribute>
                                                        <xsl:attribute name="class">td_noteditable</xsl:attribute>
                                                        <xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
