...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request">
		<html>
			<head>
				<title>
					Отчет движимое имущество -  АИС 'Коммунальное Имущество'
				</title>
						...
						<div class="formtitle">
							<div style="float:left" class="title">
								<xsl:call-template name="documentitle-reports">
									<xsl:with-param name="title">Отчет движимое имущество</xsl:with-param>
								</xsl:call-template>
							</div>
									...
									<br/>
								 	<table width="100%" border="0">
										...
										<tr>
											...
											<td>
												<input type="checkbox" name="propertytype" value="furniture"/>&#xA0;<xsl:value-of select="document/captions/furniture/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="animals"/>&#xA0;<xsl:value-of select="document/captions/animals/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="sportsequipment"/>&#xA0;<xsl:value-of select="document/captions/sportsequipment/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="others"/>&#xA0;<xsl:value-of select="document/captions/others/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="shareblocks"/>&#xA0;<xsl:value-of select="document/captions/shareblocks/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="equity"/>&#xA0;<xsl:value-of select="document/captions/equity/@caption"/>
											</td>
										</tr>
										<!-- Поле "Район" -->
										<tr>
