								...
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
										...
										<tr>
											...
											<td>
												<input type="text" value="{document/fields/amount}" style="width:100px;" class="td_editable" name="amount">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											...
											<td>
												<input type="text" value="{document/fields/breed}" style="width:500px;" class="td_editable" name="breed">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											...
											<td>
												<input type="text" value="{document/fields/age}" style="width:500px;" class="td_editable" name="age">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											...
											<td>
												<input type="text" value="{document/fields/weight}" style="width:500px;" class="td_editable" name="weight">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
