...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//query/entry">
		...
		<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}">
			...
			<td style="border:1px solid #ccc; width:80px; padding:3px">
			...
			<xsl:if test="/request/@id != 'taskforme' and /request/@id !='tasks' and /request/@id !='mytasks' and /request/@id !='completetask'">
