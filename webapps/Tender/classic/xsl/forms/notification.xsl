			...
			<div id="docwrapper">
				...
				<div class="formwrapper">
					...
					<div id="tabs">
						...
						<xsl:if test="document/fields/notificationtype ='regorder_leasing'">	
							<div style="margin:20px auto; width:900px; border:1px solid #999; min-height:300px; padding:5px; background:#FFFFFE">
								<img style="width:75px; height:75px; float:right; padding:0px 0px" src="classic/img/almaty.png" />
								<table style="width:80%; border-collapse:collapse">
									<tr>
								...
								<div style="background:#DEDEDE; width:100%; height:1px; margin-top:10px"/>
								<div style="width:100%; height:25px; text-align:center; font-weight:bold; padding-top:10px; font-size:17px">
									Уведомление о регистрации нового договора аренды
								</div>
								<div style="background:#9A9A9A; width:100%; height:2px; margin-top:10px"/>
								<table style="width:95%; margin:10px auto">
									<tr>
						...
						<xsl:if test="document/fields/notificationtype ='notif_rentpayment'">	
							<div style="margin:20px auto; width:900px; border:1px solid #999; min-height:300px; padding:5px; background:#FFFFFE">
								<img style="width:75px; height:75px; float:right; padding:0px 0px" src="classic/img/almaty.png" />
								<table style="width:80%; border-collapse:collapse">
									<tr>
									...
									<tr>
										<td style="width:130px; text-align:right; color:#808080; font-weight:bold; font-size:11px">Содержание: </td>
										<td style="text-align:left; font-size:13px; font-family:arial; padding-left:10px;">Уведомление о необходимости внесения арендной платы</td>
									</tr>
									<tr>
										<td style="width:130px; text-align:right; color:#808080; font-weight:bold; font-size:11px">Получатель: </td>
										<td style="text-align:left; font-size:13px; font-family:arial; padding-left:10px;"><xsl:value-of select="document/fields/balanceholdername"/> &lt;<xsl:value-of select="document/fields/balanceholderemail"/>&gt;</td>
								...
								<div style="background:#9A9A9A; width:100%; height:2px; margin-top:10px"/>
								<div style="width:95%; min-height:250px; margin:50px auto">
									<div style="width:20px; display:inline-block"/>Уведомляем Вас о том, что необходимо внести плату за аренду по договору :  <a class="doclink" href="{document/fields/objectlink}">№ <xsl:value-of select="document/fields/regnumber"/> от <xsl:value-of select="document/fields/regdate"/></a> на объект <a class="doclink" href="{document/fields/comobjecturl}"><xsl:value-of select="document/fields/comobjectname"/>  </a> в размере : <xsl:value-of select="document/fields/tarif"/> тенге до <xsl:value-of select="document/fields/enddatepayment"/>г 
								</div>
								<div style="background:#9A9A9A; width:100%; height:1px; margin-top:10px"/>
								<div style="width:100%; padding:10px 0 10px 0; text-align:center; font-size:10px">
									Данное уведомление было сформировано и отправлено сервером уведомлений автоматически
						...
						<xsl:if test="document/fields/notificationtype ='notif_endcontract'">	
							<div style="margin:20px auto; width:900px; border:1px solid #999; min-height:300px; padding:5px; background:#FFFFFE">
								<img style="width:75px; height:75px; float:right; padding:0px 0px" src="classic/img/almaty.png" />
								<table style="width:80%; border-collapse:collapse">
									<tr>
									...
									<tr>
										<td style="width:130px; text-align:right; color:#808080; font-weight:bold; font-size:11px">Содержание: </td>
										<td style="text-align:left; font-size:13px; font-family:arial; padding-left:10px;">Уведомление о расторжении договора</td>
									</tr>
									<tr>
										<td style="width:130px; text-align:right; color:#808080; font-weight:bold; font-size:11px">Получатель: </td>
										<td style="text-align:left; font-size:13px; font-family:arial; padding-left:10px;"><xsl:value-of select="document/fields/balanceholdername"/> &lt;<xsl:value-of select="document/fields/balanceholderemail"/>&gt;</td>
								...
								<div style="background:#9A9A9A; width:100%; height:2px; margin-top:10px"/>
								<div style="width:95%; min-height:250px; margin:50px auto">
									<div style="width:20px; display:inline-block"/>Уведомляем Вас о том, что договор :  <a class="doclink" href="{document/fields/objectlink}">№ <xsl:value-of select="document/fields/regnumber"/> от <xsl:value-of select="document/fields/regdate"/></a> на объект <a class="doclink" href="{document/fields/comobjecturl}"><xsl:value-of select="document/fields/comobjectname"/>  </a>
									 будет расторгнут по  инициативе департамента, по причине:  <xsl:value-of select="document/fields/reason"/> 
								</div>
								<div style="background:#9A9A9A; width:100%; height:1px; margin-top:10px"/>
								<div style="width:100%; padding:10px 0 10px 0; text-align:center; font-size:10px">
									Данное уведомление было сформировано и отправлено сервером уведомлений автоматически
