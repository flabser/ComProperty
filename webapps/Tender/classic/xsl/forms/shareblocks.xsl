								...
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<tr>
										...
										<td style="padding-top:5px">
											...
											<input type="hidden" value="{document/fields/registryholder/@attrval}" id="registryholder" name="registryholder"/>
										...
										<tr>
											<td class="fc">
												<xsl:value-of select="document/captions/nominalcost/@caption"/>&#xA0;:
											</td>
											<td>
												<input type="text" value="{document/fields/nominalcost}" style="width:500px;" class="td_editable" name="nominalcost">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											...
											<td>
												<input type="text" value="{document/fields/amount}" style="width:90px;" class="td_editable" name="amount" autocomplete="off" pattern="^[ 0-9]+$" onkeyup="javascript:validationnumfield(this)">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											...
											<td>
												<input type="text" value="{document/fields/parvalue}" style="width:90px;" class="td_editable" name="parvalue" autocomplete="off" pattern="\d+((.|,)\d+)?$" onkeyup="javascript:validationfloatfield(this)">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
