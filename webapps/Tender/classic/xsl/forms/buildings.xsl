				...
				<div class="formwrapper">
					...
					<div class="button_panel">
						<span style="width:80%; vertical-align:12px; float:left">
							...
							<xsl:call-template name="add_leasing"/>
							<xsl:call-template name="add_leasing_contract"/>
							<xsl:call-template name="add_rooms"/>
							<xsl:call-template name="submit_application_for_rent"/>
                            <xsl:call-template name="submit_application_for_tender"/>
						</span>
								...
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" value="{document/fields/rent_cost}" style="width:500px;" class="td_editable" name="rent_cost">
                                        ...
                                        <tr>
                                            <td class="fc">
                                                <xsl:value-of select="document/captions/rent_comment/@caption"/>&#xA0;:
                                            </td>
                                            <td>
                                                <input type="text" value="{document/fields/rent_comment}" style="width:500px;" class="td_editable" name="rent_comment">
                                                    <xsl:if test="$editmode != 'edit'">
                                                        <xsl:attribute name="readonly">readonly</xsl:attribute>
                                                        <xsl:attribute name="class">td_noteditable</xsl:attribute>
                                                        <xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
									...
									<xsl:if test="document/fields/balanceholder !=''">	
										...
										<tr>
											<td class="fc">
												<xsl:value-of select="document/captions/assignment/@caption"/>&#xA0;:
											</td>
											<td>
												<input type="text" value="{document/fields/assignment}" style="width:500px;" class="td_editable" name="assignment" title="{document/captions/assignmenttitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											<td class="fc">
												<xsl:value-of select="document/captions/countfloors/@caption"/>&#xA0;:
											</td>
											<td>
												<input type="text" value="{document/fields/countfloors}" style="width:50px;" class="td_editable" name="countfloors" title="{document/captions/countfloorstitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											<td class="fc">
												<xsl:value-of select="document/captions/usefularea/@caption"/>&#xA0;:
											</td>
											<td>
												<input type="text" value="{document/fields/usefularea}" style="width:90px;" class="td_editable" name="usefularea" autocomplete="off" pattern="\d+((.|,)\d+)?$" onkeyup="javascript:validationfloatfield(this)" title="{document/captions/usefulareatitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											<td class="fc" style="padding-top:5px">
												<xsl:value-of select="document/captions/kt/@caption"/> :
											</td>
											<td style="padding-top:5px">
												<xsl:variable name="kt" select="document/fields/kt/@attrval" />
												<select size="1" name="kt" style="width:611px;" class="select_editable">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="class">select_noteditable</xsl:attribute>
														<xsl:attribute name="disabled">disabled</xsl:attribute>
														<option value="">
															<xsl:attribute name="selected">selected</xsl:attribute>
															<xsl:value-of select="document/fields/kt"/>
														</option>
													</xsl:if>
													<option value="0">
														Другое
													</option>
													<xsl:for-each select="document/glossaries/kt/query/entry">
														<xsl:if test="lower-case(viewcontent/viewtext1) != 'другое'">
															<option value="{@docid}">
																<xsl:if test="$kt = @docid">
																	<xsl:attribute name="selected">selected</xsl:attribute>
																</xsl:if>
																<xsl:value-of select="viewcontent/viewtext1"/>
															</option>
												...
												<xsl:if test="$editmode !='edit'">
													<input type="hidden" name="kt" value="{document/fields/kt/@attrval}"/>
												</xsl:if>
											</td>
										</tr>
										<!-- Годы строительства -->
										...
										<tr>
											<td class="fc">
												<xsl:value-of select="document/captions/сellarexistence/@caption"/>&#xA0;:
											</td>
											<td>
												<input type="text" value="{document/fields/сellarexistence}" style="width:100px;" class="td_editable" name="сellarexistence" title="{document/captions/сellarexistencetitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
