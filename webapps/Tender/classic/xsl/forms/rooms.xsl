							...
							<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
										...
										</tr>title="{document/captions/assignmenttitle/@caption}">
										 	Общая площадь -->
										<tr>
											<td class="fc">
											...
											<td>
												<input type="text" value="{document/fields/totalarea}" style="width:90px;" class="td_editable" name="totalarea" autocomplete="off" pattern="\d+((.|,)\d+)?$" onkeyup="javascript:validationfloatfield(this)" title="{document/captions/totalareatitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
