	...
	<xsl:template match="//query/entry">
		...
		<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}">
			...
			<td style="width:25px; text-align:center; border:1px solid #ccc;">
                <xsl:if test="viewcontent/viewtext1 ='active'">
                    <img  src="/SharedResources/img/classic/icons/bullet_green.png"/>
                </xsl:if>
                <xsl:if test="viewcontent/viewtext1 ='closed'">
                    <img  src="/SharedResources/img/classic/icons/bullet_gray.png"/>
                </xsl:if>
			...
			<td  style="border:1px solid #ccc;width:150px;">
            ...
            <!--Размер -->
            <td  style="border:1px solid #ccc;width:200px; word-wrap:break-word; text-align:center">
                <div style="display:block; width:99%; " title="{viewcontent/viewtext}">
                    <a href="{@url}" class="doclink" style="width:90%">
                        <xsl:attribute name="onclick">javascript:beforeOpenDocument()</xsl:attribute>
                        <xsl:if test="@isread = '0'">
									...
									<div id="tableheader">
										<table class="viewtable" id="viewtable" width="100%" style="">
											<tr class="th">
                                                ...
                                                <td style="min-width:210px;" class="thcell">
                                                    <xsl:call-template name="sortingcellpage">
												...
												<td style="width:200px;" class="thcell">
													...
													</xsl:call-template>(тг)
												</td>
                                                <td style="text-align:center; height:30px; width:50px;" class="thcell">
                                                </td>
											</tr>
										</table>
									</div>
