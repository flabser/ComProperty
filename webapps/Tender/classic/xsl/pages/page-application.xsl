...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//query/entry">
		...
		<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}">
            ...
            <td style="width:40px; text-align:center; border:1px solid #ccc;">
                <xsl:choose>
                    <xsl:when test="viewcontent/viewtext2 = 'new'">
                        <img id="atach" src="/SharedResources/img/classic/icons/bullet_yellow.png" title=""/>
                    </xsl:when>
                    <xsl:when test="viewcontent/viewtext2 = 'approved'">
                        <img id="atach" src="/SharedResources/img/classic/icons/tick.png" title=""/>
                    </xsl:when>
                    <xsl:when test="viewcontent/viewtext2 = 'rejected'">
                        <img id="atach" src="/SharedResources/img/classic/icons/cross.png" title=""/>
                    </xsl:when>
                </xsl:choose>
            </td>
									...
									<div id="tableheader">
										<table class="viewtable" id="viewtable" width="100%" style="">
											<tr class="th">
												...
												<td style="text-align:center; height:30px; width:65px;" class="thcell">
												</td>
