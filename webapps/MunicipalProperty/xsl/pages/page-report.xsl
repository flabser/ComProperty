									...
									<div id="tableheader">
										<table class="viewtable" id="viewtable" width="100%" style="">
											<tr class="th">
												...
												<td class="thcell">
													<xsl:value-of select="page/captions/briefcontent/@caption"/>
								 				</td>
											</tr>
										</table>
									</div>
									...
									<div id="tablecontent">
										...
										<table class="viewtable" id="viewtable" width="100%">
											...
											<tr onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')">
												...
												<td style="border:1px solid #ccc; padding-left:5px">
													<a href="Provider?type=edit&amp;id=equipment_report&amp;key=" class="doclink">Оборудование</a>
												</td>
											</tr>
											<tr onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')">
												<xsl:attribute name="bgcolor">#FFFFFF</xsl:attribute>
												...
												<td style="border:1px solid #ccc; padding-left:5px">
													<a href="Provider?type=edit&amp;id=realestate_report&amp;key=" class="doclink">Недвижимое имущество</a>
												</td>
											</tr>
											<tr onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')">
												<xsl:attribute name="bgcolor">#FFFFFF</xsl:attribute>
												...
												<td style="border:1px solid #ccc; padding-left:5px">
													<a href="Provider?type=edit&amp;id=transport_report&amp;key=" class="doclink">Транспорт</a>
												</td>
											</tr>
											<tr onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')">
												<xsl:attribute name="bgcolor">#FFFFFF</xsl:attribute>
												...
												<td style="border:1px solid #ccc; padding-left:5px">
													<a href="Provider?type=edit&amp;id=strategicobjects_report&amp;key=" class="doclink">Стратегические объекты</a>
												</td>
											</tr>
											<tr onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')">
												<xsl:attribute name="bgcolor">#FFFFFF</xsl:attribute>
												...
												<td style="border:1px solid #ccc; padding-left:5px">
													<a href="Provider?type=edit&amp;id=engineeringInfrastructure_report&amp;key=" class="doclink">Объекты инженерной инфраструктуры</a>
												</td>
											</tr>
											<tr onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')">
												<xsl:attribute name="bgcolor">#FFFFFF</xsl:attribute>
