...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//query/entry">
		...
		<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}">
			...
			<!-- Описание документа -->
			<td  style="border:1px solid #ccc;min-width:150px; word-wrap:break-word; padding-left: 5px">
			...
			<td  style="border:1px solid #ccc;min-width:150px; word-wrap:break-word; padding-left: 5px">
				<div style="display:block; width:99%; " title="{viewcontent/viewtext}">
					<a href="{@url}" class="doclink" style="width:90%">
						...
						<xsl:value-of select="viewcontent/viewtext3"/> - <xsl:value-of select="viewcontent/viewtext4"/>
					</a>
				</div>
			</td>
			<td  style="border:1px solid #ccc;min-width:150px; word-wrap:break-word; padding-left: 5px">
				<div style="display:block; width:99%; " title="{viewcontent/viewtext}">
					<a href="{@url}" class="doclink" style="width:90%">
						...
						<xsl:if test="viewcontent/viewtext5 = '1'">
							Активен
						</xsl:if>
						<xsl:if test="viewcontent/viewtext5 = '0'">
							Неактивен
						</xsl:if>
					</a>
				</div>
									...
									<div id="tableheader">
										<table class="viewtable" id="viewtable" width="100%" style="">
											<tr class="th">
												...
												<td style="width:280px;" class="thcell">
												...
												<td style="min-width:150px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
												...
												<td style="min-width:150px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														<xsl:with-param name="namefield">VIEWTEXT4</xsl:with-param>
														<xsl:with-param name="sortorder" select="//query/columns/viewtext1/sorting/@order"/>
														<xsl:with-param name="sortmode" select="//query/columns/viewtext1/sorting/@mode"/>
													</xsl:call-template>
												</td>
												<td style="min-width:150px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														<xsl:with-param name="namefield">VIEWTEXT5</xsl:with-param>
														<xsl:with-param name="sortorder" select="//query/columns/viewtext1/sorting/@order"/>
														<xsl:with-param name="sortmode" select="//query/columns/viewtext1/sorting/@mode"/>
													</xsl:call-template>
												</td>
