...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="entry[@form='orderleasing']" mode="line"/>
	...
	<xsl:template name="graft">
		...
		<xsl:choose>
			<xsl:when  test="following-sibling::entry[@form !='orderleasing'][@form !='notification']">
	...
	<xsl:template match="*" mode="tree">
		<xsl:choose>
			<xsl:when test="following-sibling::entry[@form !='orderleasing'][@form !='notification'] and entry[@url]">
