...
<xsl:template name="docinfo">
	...
	<!-- <div class="form-group"> <div class="control-label"> <xsl:value-of 
		select="//captions/region/@caption"/> </div> <div class="controls"> <div 
		class="field-wrapper col-md-6"> <div class="form-control selection" data-input="region" 
		onclick="nbApp.choiceRegion(this)"> <xsl:value-of select="//fields/region"/> 
		</div> </div> <input type="hidden" name="region" value="{//fields/region}"/> 
		</div> </div> Поле "Город" <div class="form-group"> <div class="control-label"> 
		<xsl:value-of select="//captions/city/@caption"/> </div> <div class="controls"> 
		<div class="field-wrapper col-md-6"> <div class="form-control selection" 
		data-input="city" onclick="nbApp.choiceCity(this)"> <xsl:value-of select="//fields/city"/> 
		</div> </div> <input type="hidden" name="region" value="{//fields/city}"/> 
		</div> </div> Поле "Район" <div class="form-group"> <div class="control-label"> 
		<xsl:value-of select="//captions/district/@caption"/> </div> <div class="controls"> 
		<div class="field-wrapper col-md-6"> <div class="form-control selection" 
		data-input="district" onclick="nbApp.choiceDistrict(this)"> <xsl:value-of 
		select="//fields/district"/> </div> </div> <input type="hidden" name="region" 
		value="{//fields/district}"/> </div> </div> Поле "Улица" <div class="form-group"> 
		<div class="control-label"> <xsl:value-of select="//captions/street/@caption"/> 
		</div> <div class="controls"> <div class="field-wrapper col-md-6"> <div class="form-control 
		selection" data-input="street" onclick="nbApp.choiceStreet(this)"> <xsl:value-of 
		select="//fields/street"/> </div> </div> <input type="hidden" name="region" 
		value="{//fields/street}"/> </div> </div> Поле "Дом" <div class="form-group"> 
		<div class="control-label"> <xsl:value-of select="//captions/home/@caption"/> 
		</div> <div class="controls"> <div class="field-wrapper col-md-1"> <input 
		type="text" name="home" value="{//fields/home}" class="form-control"/> </div> 
		</div> </div> Поле "Адрес" <div class="form-group"> <div class="control-label"> 
		<xsl:value-of select="//captions/address/@caption"/> </div> <div class="controls"> 
		<div class="field-wrapper col-md-6"> <input type="text" name="address" value="{//fields/address}" 
		class="form-control"/> </div> </div> </div> Количество <div class="form-group"> 
		<div class="control-label"> <xsl:value-of select="//captions/amount/@caption"/> 
		</div> <div class="controls"> <div class="field-wrapper col-md-1"> <input 
		type="number" name="amount" value="{//fields/amount}" class="form-control"/> 
		</div> </div> </div> -->
	...
	<!-- <fieldset class="fieldset"> <legend class="legend"> <xsl:value-of select="//captions/сhange_original_cost/@caption"/> 
		</legend> <div class="form-group"> <div class="control-label"> <xsl:value-of 
		select="//captions/repair/@caption"/> </div> <div class="controls"> <div 
		class="field-wrapper col-md-6"> <input type="text" name="repair" value="{//fields/repair}" 
		class="form-control"/> </div> </div> </div> <div class="form-group"> <div 
		class="control-label"> <xsl:value-of select="//captions/depreciating/@caption"/> 
		</div> <div class="controls"> <div class="field-wrapper col-md-1"> <input 
		type="number" name="depreciating" value="{//fields/depreciating}" class="percent 
		form-control"/> </div> </div> </div> <div class="form-group"> <div class="control-label"> 
		<xsl:value-of select="//captions/cumulativedepreciation/@caption"/> </div> 
		<div class="controls"> <div class="field-wrapper col-md-1"> <input type="number" 
		name="cumulativedepreciation" value="{//fields/cumulativedepreciation}" class="percent 
		form-control"/> </div> </div> </div> <div class="form-group"> <div class="control-label"> 
		<xsl:value-of select="//captions/deterioration/@caption"/> </div> <div class="controls"> 
		<div class="field-wrapper col-md-1"> <input type="number" name="deterioration" 
		value="{//fields/deterioration}" class="percent form-control"/> </div> </div> 
		</div> </fieldset> -->
