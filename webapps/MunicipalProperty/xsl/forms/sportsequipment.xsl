								...
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
										...
										<tr>
											...
											<td>
												<input type="text" value="{document/fields/amount}" style="width:60px;" class="td_editable" name="amount" autocomplete="off" pattern="^[ 0-9]+$" onkeyup="javascript:validationnumfield(this)" title="{document/captions/amounttitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											...
											<td>
												<input type="text" value="{document/fields/totalcost}" style="width:90px;" class="td_editable" name="totalcost" autocomplete="off" pattern="\d+((.|,)\d+)?$" onkeyup="javascript:validationfloatfield(this)" title="{document/captions/totalcosttitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											...
											<td>
												...
												<input type="text" value="{document/fields/yearrelease}" style="width:40px;" class="td_editable" name="yearrelease" autocomplete="off" pattern="^18\d\d$|^19\d\d$|^20[{substring($year,3,1)}][0-{substring($year,4,1)}]$|^200[0-9]$" onkeyup="javascript:validationyearfield(this)" title="{document/captions/yearreleasetitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
