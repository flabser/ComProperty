								...
								<div class="ui-tabs-panel" id="tabs-1">
									...
									<table width="100%" border="0">
										...
										<tr>
											...
											<td style="padding-top:5px">
												<xsl:variable name="type" select="document/fields/type/@attrval" />
												<select size="1" name="animalstype" style="width:611px;" class="select_editable">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="class">select_noteditable</xsl:attribute>
														<xsl:attribute name="disabled">disabled</xsl:attribute>
														<option value="">
												...
												<xsl:if test="$editmode !='edit'">
													<input type="hidden" name="animalstype" value="{document/fields/type/@attrval}"/>
												</xsl:if>
											</td>
										</tr>
										<!-- 	Порода -->
										<tr>
											<td class="fc">
												<xsl:value-of select="document/captions/breed/@caption"/>&#xA0;:
											</td>
											<td>
												<input type="text" value="{document/fields/breed}" style="width:500px;" class="td_editable" name="breed" title="{document/captions/breedtitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											...
											<td>
												<input type="text" value="{document/fields/age}" style="width:500px;" class="td_editable" name="age" pattern="^[ 0-9]+$" onkeyup="javascript:validationnumfield(this)" title="{document/captions/agetitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
										...
										<tr>
											<td class="fc">
												<xsl:value-of select="document/captions/weight/@caption"/>&#xA0;:
											</td>
											<td>
												<input type="text" value="{document/fields/weight}" style="width:500px;" class="td_editable" name="weight" pattern="\d+((.|,)\d+)?$" onkeyup="javascript:validationfloatfield(this)" title="{document/captions/weighttitle/@caption}">
													<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
														<xsl:attribute name="onfocus">javascript:$(this).blur()</xsl:attribute>
