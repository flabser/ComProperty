						...
						<div class="formtitle">
							<div style="float:left" class="title">
								<xsl:call-template name="documentitle-reports">
									<xsl:with-param name="title">Отчет стратегические объекты</xsl:with-param>
								</xsl:call-template>
							</div>
									...
									<br/>
								 	<table width="100%" border="0">
										...
										<tr>
											...
											<td>
												<input type="checkbox" name="propertytype" value="objectreservedfund"/>&#xA0;<xsl:value-of select="document/captions/objectreservedfund/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="bombproof"/>&#xA0;<xsl:value-of select="document/captions/bombproof/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="factory"/>&#xA0;<xsl:value-of select="document/captions/factory/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="combines"/>&#xA0;<xsl:value-of select="document/captions/combines/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="airport"/>&#xA0;<xsl:value-of select="document/captions/airport/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="transitions"/>&#xA0;<xsl:value-of select="document/captions/transitions/@caption"/>
											</td>
										</tr>
