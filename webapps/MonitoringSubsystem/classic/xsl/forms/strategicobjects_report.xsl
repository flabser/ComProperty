...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/request">
		<html>
			<head>
				<title>
					Отчет стратегические объекты - АИС 'Коммунальное Имущество'
				</title>
				...
				<xsl:if test="document/@editmode='edit'">
					<xsl:if test="/request/@lang = 'RUS'">
						<script>
							$(function(){
							var dates = $( "#acceptancedatefrom, #acceptancedateto"
							).datepicker({
							defaultDate: "+1w",
							showOn: "button",
							buttonImage:
							'/SharedResources/img/iconset/calendar.png',
							buttonImageOnly:
							true,
							changeMonth: true,
							changeYear: true,
							...
							var option = this.id == "acceptancedatefrom" ? "minDate" :
							"maxDate",
					...
					<xsl:if test="/request/@lang = 'KAZ'">
						<script>
							...
							'Шілде','Тамыз','Қыркүйек','Қазан','Қараша','Желтоқсан'],
							dayNames:
							['жексебі','дүйсенбі','сейсенбі','сәрсенбі','бейсенбі','жұма','сенбі'],
					...
					<div class="formwrapper">
						...
						<div class="button_panel">
							<span style=" vertical-align:12px; float:left">
								...
								<!-- <xsl:if test="document/fields/allcontrol != '0' and document/@editmode 
									='edit'"> -->
							...
							<span style="float:right" class="bar_right_panel">
								<button
									...
									title="{document/captions/close/@caption}" id="canceldoc">
									<xsl:attribute name="onclick">javascript:CancelForm(&quot;<xsl:value-of
										select="history/entry[@type eq 'view'][last()]" />&quot;,&quot;<xsl:value-of
										select="document/fields/grandparform" />&quot;)</xsl:attribute>
									<span>
									...
									<table width="100%" border="0">
										...
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px">
												<xsl:value-of select="document/captions/propertytype/@caption" />
												:
											</td>
											<td>
												<input type="checkbox" name="propertytype" value="objectreservedfund" />
												&#xA0;
												<xsl:value-of
													select="document/captions/objectreservedfund/@caption" />
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="bombproof" />
												&#xA0;
												<xsl:value-of select="document/captions/bombproof/@caption" />
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="factory" />
												&#xA0;
												<xsl:value-of select="document/captions/factory/@caption" />
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="combines" />
												&#xA0;
												<xsl:value-of select="document/captions/combines/@caption" />
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="airport" />
												&#xA0;
												<xsl:value-of select="document/captions/airport/@caption" />
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="transitions" />
												&#xA0;
												<xsl:value-of select="document/captions/transitions/@caption" />
											</td>
										</tr>
							...
							<div id="executers" style="display:none">
								<table style="width:100%">
									<xsl:for-each select="document/fields/executors/entry">
										<tr>
											<td>
												<input type="checkbox" name="chbox" value="{user}"
													id="{user/@attrval}">
											...
											<td>
												<font class="font"
													style="font-family:verdana; font-size:13px; margin-left:2px">
													<xsl:if test="user/@attrval =''">
