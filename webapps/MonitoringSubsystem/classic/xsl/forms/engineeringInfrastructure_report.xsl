...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request">
		<html>
			<head>
				<title>
					Отчет объекты инженерной инфраструктуры -  АИС 'Коммунальное Имущество'
				</title>
									...
									<br/>
								 	<table width="100%" border="0">
										...
										<tr>
											...
											<td>
												<input type="checkbox" name="propertytype" value="billboard"/>&#xA0;<xsl:value-of select="document/captions/billboard/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="columns"/>&#xA0;<xsl:value-of select="document/captions/columns/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="electricnetworks"/>&#xA0;<xsl:value-of select="document/captions/electricnetworks/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="thermalnetworks"/>&#xA0;<xsl:value-of select="document/captions/thermalnetworks/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="gas"/>&#xA0;<xsl:value-of select="document/captions/gas/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="watersystem"/>&#xA0;<xsl:value-of select="document/captions/watersystem/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="drain"/>&#xA0;<xsl:value-of select="document/captions/drain/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="road"/>&#xA0;<xsl:value-of select="document/captions/road/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="parking"/>&#xA0;<xsl:value-of select="document/captions/parking/@caption"/>
											</td>
										</tr>
