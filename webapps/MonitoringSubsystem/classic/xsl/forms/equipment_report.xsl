...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request">
		<html>
			<head>
				<title>
					Отчет оборудование -  АИС 'Коммунальное Имущество'
				</title>
						...
						<div class="formtitle">
							<div style="float:left" class="title">
								<xsl:call-template name="documentitle-reports">
									<xsl:with-param name="title">Отчет оборудование</xsl:with-param>
								</xsl:call-template>
							</div>
									...
									<br/>
								 	<table width="100%" border="0">
										...
										<tr>
											...
											<td>
												<input type="checkbox" name="propertytype" value="schoolequipment"/>&#xA0;<xsl:value-of select="document/captions/schoolequipment/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="officeequipment"/>&#xA0;<xsl:value-of select="document/captions/officeequipment/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="computerequipment"/>&#xA0;<xsl:value-of select="document/captions/computerequipment/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="medicalequipment"/>&#xA0;<xsl:value-of select="document/captions/medicalequipment/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="cookequipment"/>&#xA0;<xsl:value-of select="document/captions/cookequipment/@caption"/>
											</td>
										</tr>
										<tr>
											<td class="fc" style="padding:5px;position:relative;top:0px"></td>
											<td>
												<input type="checkbox" name="propertytype" value="equipmentofcivildefense"/>&#xA0;<xsl:value-of select="document/captions/equipmentofcivildefense/@caption"/>
											</td>
										</tr>
