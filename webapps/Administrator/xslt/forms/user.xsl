...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/request">
		<head>
			<title>
				Administrator - User&#xA0;-<xsl:value-of select="document/userid"/>
			</title>
			...
			<form action="Provider" method="post" id="scriptest" enctype="application/x-www-form-urlencoded">
				<table border="0" style="margin-top:10px;width:100%">
					...
					<tr>
						...
						<td>
							<input type="password" name="oldpwd" id="pwd1" size="20" value="{document/password}"/>
							&#xA0;
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="password" name="pwd" id="pwd2" size="20" value="{document/password}"/>
							&#xA0;
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<spin style="font-size:0.7em">*if you enable this role, the server will
								disable special administrator access</spin>
						</td>
					</tr>
					</table>
