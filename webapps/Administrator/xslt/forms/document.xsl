				...
				<table style="font-family:verdana; margin-top:10px; width:90%; font-size:0.8em;  margin-left:10px">
					...
					<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
						...
						<tr class="newreader">
							...
							<td>
								<input type="text" size='25' style="margin-left:5px" onkeyup="javascript:autocomplete(this)">
									<xsl:attribute name="name">reader</xsl:attribute>
								</input>&#xA0;<a id="linktofullstructurereader" href="javascript:selectIDtoField($('.newreader input'))" style="font-size:12px">Select</a>
							</td>
							<td></td>
						</tr>
