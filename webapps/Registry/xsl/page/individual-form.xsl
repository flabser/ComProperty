...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
        ...
        <form name="{@entity}" action="" data-edit="{@editable}">
            <header class="content-header">
                <h1 class="header-title">
                    <xsl:value-of select="//captions/individual/@caption"/>
                </h1>
            ...
            <section class="content-body">
                <fieldset class="fieldset">
                   ...
                   <div class="form-group">
                        ...
                        <div class="controls">
                        	  <input type="text" name="balanceholderbin" value="{fields/orgcategory}" class="span4"
                       disabled="disabled"/>
    ...
    <xsl:template match="entry" mode="labels">
        ...
        <xsl:if test="viewcontent/name = 'Balance holder'">
            <div>
