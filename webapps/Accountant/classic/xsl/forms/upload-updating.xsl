...
<xsl:stylesheet version="2.0"
	...
	<xsl:variable name="doctype"
		select="request/document/captions/name/@caption" />
					...
					<div class="formwrapper">
						...
						<div class="button_panel">
							<span style="float:left">
								...
								<button title="{document/captions/saveclose/@hint}"
									...
									<span>
										...
										<font style="font-size:12px; vertical-align:top">
											<xsl:value-of select="document/captions/saveclose/@caption" />
										</font>
									</span>
								</button>
								<button style="margin-left:5px" title="Подписать"
									class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
									id="btnsavedoc">
							...
							<span style="float:right; margin-right:5px">
								<button title="{document/captions/close/@hint}"
									class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
									id="canceldoc">
									<xsl:attribute name="onclick">javascript:window.history.back()</xsl:attribute>
									<span>
										<img src="/SharedResources/img/classic/icons/cross.png"
											class="button_img" />
										<font style="font-size:12px; vertical-align:top">
						...
						<div id="tabs">
							...
							<div class="ui-tabs-panel" id="tabs-2">
								<form action="UploadEDS" name="uploadcert" id="uploadcert"
									method="post" enctype="multipart/form-data">
									<!--<input type="hidden" name="type" value="rtfcontent"/> <input 
										type="hidden" name="formsesid" value="{formsesid}"/> -->
									<!-- Секция "Вложения" -->
									<div display="block" id="att">
										<br />
								...
								<table width="100%" border="0">
									...
									<tr>
										...
										<td style="padding-top:5px">
											...
											<input type="hidden" value="{document/fields/balanceholder}"
												id="balanceholder2" name="balanceholder2" />
